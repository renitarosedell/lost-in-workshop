...
You know where you need to go, specifically stop 1 of your quest. But how do you get there? Raleigh has buses, bikes, rideshare, and greenways. Rather than hardcoding the answer, your agent will consult a **remote expert agent** that specialises in Raleigh transport.
...
You just called a *remote AI agent* as if it were a function. The transport expert has its own model, its own knowledge, and its own system prompt, and you just asked a question and got an expert answer. This is the power of the A2A pattern: you compose specialists without knowing how they work internally.
