...
redirect: /workshop/step1
---

# Lost in Raleigh — Workshop Guide

::: info This page has moved
The workshop is now split into individual step pages for easier navigation.
Please use the sidebar on the left to jump to the step you need, or start from [Step 1](step1).
:::
